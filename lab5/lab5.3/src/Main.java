...
import java.util.*;
public class Main {
    public static void main(String[] args) throws OperatorDataException,InvalidCredentialsException {
        ...
        test1.add(new Phone_Operator("Zamula","Margo","Viktorovna",
                "Tbilisi",8792032423167L,0.0,1942.0,168,654));
        ...
        //ArrayList<Phone_Operator> listLocalLimit1 = test1;
        ...
        ArrayList<Phone_Operator> listLocalLimit = test1.getClientsLocalLimitsTime(1000);
        ...
        ArrayList<Phone_Operator> listInter = test1.getClientsByInternationTime(0);
